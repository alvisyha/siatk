...
export default function KategoriPage() {
    ...
    const handleDeleteClick = (kategori: Kategori) => {
    ...
    const handleDeleteConfirm = async () => {
        ...
        try {
            const res = await fetch(`/api/kategori/${kategoriToDelete.id}`, {
                method: 'DELETE'
            });
        ...
        <div className="space-y-6 animate-in fade-in duration-500">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-gray-500 text-sm mt-1">Kelola kategori pengelompokan barang</p>
                </div>
                <button
                        ...
                        <tbody className="divide-y divide-gray-200">
                            {isLoading ? (
                                ...
                                filteredKategori.map((kategori) => (
                                    <tr key={kategori.id} className="hover:bg-gray-50/50 transition-colors group">
                        ...
                        <form onSubmit={handleSave} className="p-6 space-y-5">
                            <div>
                                ...
                                <input
                                    ...
                                    placeholder="Contoh: Elektronik, ATK, Perabot"
                                />
                            </div>
                            <div>
            ...
            {isDeleteModalOpen && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-gray-900/40 backdrop-blur-sm animate-in fade-in duration-200">
                    <div className="bg-white rounded-2xl shadow-xl w-full max-w-sm p-6 animate-in zoom-in duration-300">
                        ...
                        <h3 className="text-lg font-bold text-gray-900 text-center mb-2">Hapus Kategori?</h3>
                        <p className="text-gray-500 text-center text-sm mb-6">
                            Apakah Anda yakin ingin menghapus kategori <span className="font-semibold text-gray-900">"{kategoriToDelete?.nama}"</span>? Tindakan ini tidak dapat dibatalkan.
                        </p>
